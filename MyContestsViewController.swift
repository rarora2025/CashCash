...
class MyContestsViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if contests[0]["loading"] != 404{
            ...
            var chars = full.count
             cell.textLabel?.text = String(full.suffix(chars-6))
    ...
    var contests : [[String:Int]] = [["loading":404]]
    override func viewDidLoad() {
        ...
        let profilePath = ref.child("users").child(userID!).child("my_contests")
